          ...
          {cart.length === 0 ? (
            <div className="text-center py-20 bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl rounded-[3rem] border border-white/60 dark:border-slate-700 shadow-lg transition-colors">
                ...
                <motion.button 
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={() => navigate('/')} 
                    className="bg-slate-900 dark:bg-white px-8 py-4 rounded-full text-white dark:text-slate-900 font-bold hover:bg-slate-800 dark:hover:bg-slate-200 transition shadow-lg"
                >
                    Start Shopping
                </motion.button>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
                  ...
                  >
                    ...
                    <div className="flex flex-row md:flex-col items-center md:items-end gap-3 w-full md:w-auto justify-between md:justify-start">
                      ...
                      <motion.button 
                        ...
                        className="text-red-400 hover:text-red-600 text-xs font-bold underline decoration-red-200 hover:decoration-red-600 transition"
                      >
                        Remove
                      </motion.button>
                    </div>
              ...
              <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur p-6 md:p-8 rounded-[2.5rem] border border-white dark:border-slate-700 shadow-xl h-fit sticky top-24 transition-colors">
                ...
                <motion.button 
                    ...
                    className="w-full bg-gradient-to-r from-slate-900 to-slate-800 dark:from-violet-600 dark:to-fuchsia-600 text-white py-4 rounded-2xl font-bold shadow-lg hover:shadow-xl transition flex justify-center gap-2 items-center"
                >
